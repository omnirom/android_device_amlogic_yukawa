...
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 156008448 # ~150MB
else
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 262144000 # 250MB
endif
...
BOARD_KERNEL_IMAGE_LZ4 := true
BOARD_KERNEL_SEPARATED_DTBO := true
BOARD_INCLUDE_DTB_IN_BOOTIMG := false
BOARD_CUSTOM_DTBOIMG_MK := device/amlogic/yukawa/kernel/omni_dtimages.mk
TARGET_KERNEL_SOURCE := kernel/amlogic/yukawa
TARGET_KERNEL_CONFIG := ../../../../../../device/amlogic/yukawa/kernel/omni_meson_510_defconfig
...
DEVICE_MANIFEST_FILE += device/amlogic/yukawa/hal/gps/manifest.xml

BUILD_BROKEN_ELF_PREBUILT_PRODUCT_COPY_FILES := true

TARGET_INIT_VENDOR_LIB := //device/amlogic/yukawa:libinit_yukawa
